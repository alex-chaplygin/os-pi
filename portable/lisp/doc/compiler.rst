...
:TAIL-CALL name env args: Хвостовой вызов функции с именем name, номером окружения env и списком выражений аргументов args (фиксированное число аргументов).
:TAIL-NCALL name num env args: Хвостовой вызов функции с именем name, номером окружения env и списком выражений аргументов args (переменное число аргументов).
			      num - число фиксированных аргументов.			      
