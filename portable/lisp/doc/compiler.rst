...
Память машины разделяется на память программы (где хранится байт код программы), память глобальных переменных, стек и список кадров активации.

В памяти программы хранятся инструкции программы в виде объектов NUMBER. В памяти глобальных переменных могут храниться объекты любых типов.
...
.. table:: Список инструкций
===  ==========     =============================================================
Код  Имя            Описание
===  ==========     =============================================================
0    CONST expr     поместить expr в регистр ACC.
...
14   FIX-CLOSURE o  в регистр ACC добавляется объект замыкание с текущим
                    окружением и смещением на код функции относительно текущего
		    адреса o.
