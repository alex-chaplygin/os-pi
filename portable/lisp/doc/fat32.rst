...
Найти свободную запись в каталоге. Это или удаленный файл, или свободная запись.

Создать объект Fat32File.

Создать новую запись в каталоге по номеру блока. (write-struct <array> <offset> <struct> <хеш-объект значений - файл-объект>). write-block - запись блока.
