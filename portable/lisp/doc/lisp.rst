...
#. (strtofloat str) - Преобразует строку в число с плавающей точкой.
   ::
      > (strtofloat "12.34")
      12.34

#. (numbertostr n) - Преобразует число в строку.
   ::
      > (numbertostr 123)
      "123"

#. (string-upcase str) - Преобразует строку в верхний регистр.
   ::
      > (string-upcase "abc")
      "ABC"

#. (safe-strtoint str base) - Безопасное преобразование строки в 32-битное знаковое целое. Возвращает число или nil, если переполнение или недопустимая цифра.
   ::
      > (safe-strtoint "123" 10)
      123
      > (safe-strtoint "-1" 10)
      -1
      > (safe-strtoint "overflow" 10)
      NIL
