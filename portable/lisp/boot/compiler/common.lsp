...
(defvar *fix-primitives*
  '((car . 1) (cdr . 1) (atom . 1) (cons . 2) (rplaca . 2) (rplacd . 2)
    ...
    (symbolp . 1) (integerp . 1) (pairp . 1) (functionp . 1) (gensym . 0) (apply . 2) (inb . 1) (inw . 1) (indw . 1) (insw . 2) (outb . 2) (outw . 2) (outdw . 2) (outsw . 2) (set-cursor . 2) (set-color . 2) (set-back-color . 2) (hide-cursor . 0) (show-cursor . 0) (set-int-handler . 2) (send-text-buffer . 5) (send-graphics-buffer . 5)))
