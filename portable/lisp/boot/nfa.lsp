...
(defun make-nfa(start-states rules final-states)
  ...
  "Вывод: объект НКА"
  "Список начальных состояний - список из символов всех состояний, к-рые нужно проанализировать (исп. только в дальнейшем в объекте автомат, при задании НКА состоит из 1 состояния)"
