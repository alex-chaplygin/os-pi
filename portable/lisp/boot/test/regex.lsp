...
(deftest test-regex ()
  ...
  (print (assert (match "abc" "a.c") 't))
  (print (assert (match "offsabc4de" "abc4d") "abc4d"))
  (print (assert (match "offsabc4d" "abc4d") 't))
  (print (assert (match "abc4daaa" "abc4d") "abc4d"))
  (print (assert (match "abc4d" "abc4d") 't))
  ...
  (print (assert (match "aaaat" "a*t") 't))
  ...
  (print (assert (match "string" ".*") ""))
  (print (assert (match "taaaabw" "a*b.$") "aaaabw"))
  (print (assert (match "test    string 123" "test * str.*2") "test    string 12"))
  (print (assert (match "ABCXYZ" "^A.*Z$") "ABCXYZ"))
  (print (assert (match "abcktrrrq" ".+ktr+") "abcktrrr"))
  (print (assert (match "abcktrrrq" ".+ktr+") "abcktr"))
